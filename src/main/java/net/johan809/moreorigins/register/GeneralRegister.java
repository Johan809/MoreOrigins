...
import net.johan809.moreorigins.enchantments.IceAspectEnchantment;
...
import net.johan809.moreorigins.enchantments.WitherAspectEnchantment;
...
public class GeneralRegister {
	...
	public static final Enchantment SOARING_ENCHANTMENT = new SoaringEnchantment(Enchantment.Rarity.RARE,
			EnchantmentTarget.ARMOR_CHEST, new EquipmentSlot[] { EquipmentSlot.CHEST });
	public static final Enchantment ICE_ASPECT_ENCHANTMENT = new IceAspectEnchantment(Enchantment.Rarity.RARE,
			EnchantmentTarget.WEAPON, new EquipmentSlot[] { EquipmentSlot.MAINHAND });

	public static final Enchantment WITHER_ASPECT_ENCHANTMENT = new WitherAspectEnchantment(Enchantment.Rarity.RARE,
			EnchantmentTarget.WEAPON, new EquipmentSlot[] { EquipmentSlot.MAINHAND });
	...
	public static void register() {
		...
		Registry.register(Registry.ENCHANTMENT, new Identifier(MoreOrigins.MODID, "ice_aspect"), ICE_ASPECT_ENCHANTMENT);
		Registry.register(Registry.ENCHANTMENT, new Identifier(MoreOrigins.MODID, "wither_aspect"),
				WITHER_ASPECT_ENCHANTMENT);
	}
}